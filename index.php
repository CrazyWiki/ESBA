...
Propósito: Muestra la página principal del sitio web.
Inicia la sesión PHP si aún no está iniciada.
-->
<section class="hero">
  <div class="content-wrapper"> 
    <h1>Soluciones Logísticas PF</h1>
    <p>Transporte de carga pesada, paquetería urgente y logística de última milla. Su envío, nuestra prioridad.</p>
  ...
  <div class="content-wrapper"> 
    ...
    <div id="servicesCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php
            // Array con la información de los servicios para el carrusel
            $lista_servicios = [
